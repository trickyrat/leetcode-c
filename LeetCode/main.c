...
static void test_two_sum() {
    ...
    assert_memory_equal(ARRAY(int, 0, 1), actual, 2);
}

static void test_add_two_numbers() {
    ListNode *actual1 = add_two_numbers(create_list_node(ARRAY(int, 2, 4, 3), 3), create_list_node(ARRAY(int, 5, 6, 4), 3));
    ListNode *actual2 = add_two_numbers(create_list_node(ARRAY(int, 0), 1), create_list_node(ARRAY(int, 0), 1));
    ListNode *actual3 = add_two_numbers(create_list_node(ARRAY(int, 9, 9, 9, 9, 9, 9, 9), 7), create_list_node(ARRAY(int, 9, 9, 9, 9), 4));
...
static void test_remove_element() {
    assert_int_equal(remove_element(ARRAY(int, 3, 2, 2, 3), 4, 3), 2);
    assert_int_equal(remove_element(ARRAY(int, 0, 1, 2, 2, 3, 0, 4, 2), 8, 2), 5);
}
...
static void test_rotate_image() {
    ...
    int expected2[4][4] = {{15, 13, 2, 5},
                           ...
                           {12, 6, 8, 9},
                           {16, 7, 10, 11}};
    int matrix_col_size2 = 0;

    rotate_image(matrix1, 3, &matrix_col_size1);
    assert_memory_equal(expected1, matrix1, 3 * 3);

    rotate_image(matrix2, 4, &matrix_col_size2);
    assert_memory_equal(expected2, matrix2, 4 * 4);
}
...
static void test_find_diagonal_order() {
    ...
    assert_memory_equal(expected1, actual1, 9);
    assert_memory_equal(expected2, actual2, 4);
}
...
//    assert_memory_equal(ARRAY(int, 2, 3, 5, 4, 1, 7), 6, actual1, returnSize1)
//    assert_memory_equal(ARRAY(int, 1, 4, 2, 3, 3, 2, 4, 1), 8, actual2, returnSize2)
//    assert_memory_equal(ARRAY(int, 1, 2, 1, 2), 4, actual3, returnSize3)
//}
//
...
//    assert_memory_equal(ARRAY(int, 4, 2, 4, 2, 3), 5, actual1, returnSize1)
//    assert_memory_equal(ARRAY(int, 1, 2, 3, 4, 5), 5, actual2, returnSize2)
//    assert_memory_equal(ARRAY(int, 9, 0, 1, 6), 4, actual3, returnSize3)
//}
//
...
//    assert_memory_equal(ARRAY(int, 4, 2, 1, 3), 4, actual1, returnSize1);
//    assert_memory_equal(ARRAY(int, 0), 1, actual2, returnSize2);
//}
//
...
//    assert_memory_equal(ARRAY(int, 0, 3), 2, actual1, returnSize1);
//    assert_memory_equal(ARRAY(int, -1, -1), 2, actual2, returnSize2);
//    assert_memory_equal(ARRAY(int, 0, 2), 2, actual3, returnSize3);
//}
//
//static void test_distinct_subseq_ii() {
//    assert_int_equal(7, distinct_subseq_ii("abc"));
//    assert_int_equal(6, distinct_subseq_ii("aba"));
//    assert_int_equal(3, distinct_subseq_ii("aaa"));
//}
//
...
//    assert_memory_equal(ARRAY(int, 0, 4, 1, 3, 2), 5, actual1, returnSize1);
//    assert_memory_equal(ARRAY(int, 0, 1, 2, 3), 4, actual2, returnSize2);
//    assert_memory_equal(ARRAY(int, 3, 2, 0, 1), 4, actual3, returnSize3);
//}
//
...
//    assert_int_equal(1, recentCounterPing(obj, 1));
//    assert_int_equal(2, recentCounterPing(obj, 100));
//    assert_int_equal(3, recentCounterPing(obj, 3001));
//    assert_int_equal(3, recentCounterPing(obj, 3002));
